	...
	demo.controller("main", ["$scope", "WebIMWidget","$http",function($scope,WebIMWidget,$http) {
	  ...
	  WebIMWidget.init({
	    ...
	    token:"lkq4w80oW2rFVTikLZgQphVUYfso8rAGhPbErpceSLeEo0APdHF692CYHxlgW9X0QJyEUElG/SGWvCbzthWHHw==",
	    ...
	    onSuccess:function(id){
	      ...
	      // WebIMWidget.setConversation(WebIMWidget.EnumConversationType.PRIVATE,"2","lucy");
	      //设置用户信息
